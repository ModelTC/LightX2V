...
def main():
    ...
    parser.add_argument(
        "-t",
        "--model_type",
        choices=["wan_dit", "h3", "h3_text_encoder", "h3_video_vae_encoder", "hunyuan_dit", "wan_t5", "wan_clip", "wan_animate_dit", "qwen_image_dit", "qwen25vl_llm", "z_image_dit", "self_forcing"],
        default="wan_dit",
        help="Model type",
    )
