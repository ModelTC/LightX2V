...
config_path="${CONFIG_PATH:-${lightx2v_path}/configs/platforms/ascend_npu/extreme/wan_moe_t2v_distill_int8_dynamic_sparse_attn_sp_parallel.json}"
save_result_path="${SAVE_RESULT_PATH:-${lightx2v_path}/save_results/output_lightx2v_wan22_moe_t2v_int8_dynamic_sparse_int8_comm_npu_sp8.mp4}"
