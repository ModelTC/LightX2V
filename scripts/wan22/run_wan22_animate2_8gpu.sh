...
--model_cls wan2.2_animate2 \
--task animate \
--model_path "${model_path}" \
--config_json "${lightx2v_path}/configs/wan22/wan_animate2_8gpu.json" \
...
--seed -1 \
--save_result_path "${lightx2v_path}/save_results/output_lightx2v_wan22_animate2_8gpu.mp4"
