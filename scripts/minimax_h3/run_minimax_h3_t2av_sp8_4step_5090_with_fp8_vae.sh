...
model_path=/data/wangyingrui/models/minimax_h3/h3_hf_bf16
...
--config_json ${lightx2v_path}/configs/minimax_h3/dmd/minimax_h3_sp8_4step_5090_with_fp8_vae.json \
...
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_minimax_h3_sp8_4step_5090_with_fp8_vae.mp4 \
--seed 42