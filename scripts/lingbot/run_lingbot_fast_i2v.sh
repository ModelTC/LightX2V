...
model_path=/models/lingbot-world-fast/
...
--negative_prompt "" \
--image_path /mnt/devsft_afs_2/gushiqiao/lingbot-world/examples/03/image.jpg \
--action_path /mnt/devsft_afs_2/gushiqiao/lingbot-world/examples/03/ \
