...
echo "flashinfer_autotune_cache=${flashinfer_autotune_cache:-${lightx2v_path}/save_results/hunyuan_image3_flashinfer_autotune_t2i_dist_cfg_parallel.json}"
...
torchrun --nproc_per_node="${nproc_per_node:-2}" -m lightx2v.infer \
    ...
    --flashinfer_autotune_cache "${flashinfer_autotune_cache:-${lightx2v_path}/save_results/hunyuan_image3_flashinfer_autotune_t2i_dist_cfg_parallel.json}" \
