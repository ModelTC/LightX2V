...
--audio_list ${lightx2v_path}/assets/inputs/audio/multi_person/p1.mp3,${lightx2v_path}/assets/inputs/audio/multi_person/p2.mp3 \
--mask_list ${lightx2v_path}/assets/inputs/audio/multi_person/p1_mask.png,${lightx2v_path}/assets/inputs/audio/multi_person/p2_mask.png \
