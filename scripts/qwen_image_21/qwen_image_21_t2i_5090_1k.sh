...
config_json=${CONFIG_JSON:-"${lightx2v_path}/configs/qwen_image_21/qwen_image_21_5090_1k.json"}
...
python -m lightx2v.infer \
    ...
    --seed 42 \
    --save_result_path "${SAVE_RESULT_PATH:-${lightx2v_path}/save_results/qwen_image_21_t2i_5090_1k.png}"
