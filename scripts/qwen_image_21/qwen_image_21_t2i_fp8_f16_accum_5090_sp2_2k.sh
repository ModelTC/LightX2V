...
torchrun --nproc_per_node=2 -m lightx2v.infer \
    ...
    --config_json "${lightx2v_path}/configs/qwen_image_21/qwen_image_21_t2i_fp8_f16_accum_5090_sp2_2k.json" \
    ...
    --size 2048 2048 \
    --seed 42 \
    --save_result_path "${lightx2v_path}/save_results/qwen_image_21_t2i_fp8_f16_accum_sp2_2k.png"
