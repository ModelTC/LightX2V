...
# Set the project/model paths here and both quantized checkpoint paths in the JSON config.
...
python -m lightx2v.infer \
    ...
    --config_json "${lightx2v_path}/configs/qwen_image_21/qwen_image_21_i2i_fp8_f16_accum_5090_2k_vae_fp8.json" \
    ...
    --size 2048 2048 \
    --seed 42 \
    --save_result_path "${lightx2v_path}/save_results/qwen_image_21_i2i_fp8_f16_accum_2k_vae_fp8.png"
