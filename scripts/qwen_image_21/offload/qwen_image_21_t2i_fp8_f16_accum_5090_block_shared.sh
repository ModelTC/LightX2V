...
torchrun --nproc_per_node=2 -m lightx2v.infer \
    ...
    --config_json "${lightx2v_path}/configs/qwen_image_21/offload/qwen_image_21_t2i_fp8_f16_accum_5090_block_shared.json" \
    ...
    --size 2048 2048 \
    --seed 42 \
    --save_result_path "${lightx2v_path}/save_results/qwen_image_21_t2i_fp8_f16_accum_block_shared.png"
