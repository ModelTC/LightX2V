...
--config_json ${lightx2v_path}/configs/hunyuan_video_15/hunyuan_video_15_08_t2v_480p_quant.json \
...
--negative_prompt "" \
--save_result_path ${lightx2v_path}/save_results/output_lightx2v_hunyuan_video_15_t2v_.mp4 \
