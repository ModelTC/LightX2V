...
from cutlass.cutlass_dsl import Float32, Int32, extract_mlir_values, min, new_from_mlir_values
...
class FusedMask:
    ...
    def apply_mask(
        ...
        offset = 0
        offset = seqlen_k - seqlen_q if cutlass.const_expr(mask_type is MaskEnum.WINDOW_MASK_INFERENCE or mask_type is MaskEnum.WINDOW_MASK_BWD_INFERENCE) else 0
