...
class WanVAE:
    ...
    def encode(self, video, world_size_h=1, world_size_w=1):
        """
...
if __name__ == "__main__":
    ...
    vae = WanVAE(dtype=torch.bfloat16, parallel=True)
    x = torch.randn(1, 3, 81, 688, 1344, dtype=torch.bfloat16, device="cuda")
    z = vae.encode(x)
    print(z.shape)
