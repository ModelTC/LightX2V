...
from lightx2v.models.networks.lyra2._imaginaire.lazy_config import LazyCall as L
from lightx2v.models.networks.lyra2._imaginaire.lazy_config import LazyDict
from lightx2v.models.networks.lyra2._imaginaire.utils import callback, distributed
from lightx2v.models.networks.lyra2.lyra2_utils import Color
...
@attrs.define(slots=False)
class TrainerConfig:
    type: type = object  # ImaginaireTrainer not needed for inference
