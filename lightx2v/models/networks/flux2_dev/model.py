...
from lightx2v.models.networks.flux2_dev.infer.pre_infer import Flux2DevPreInfer
from lightx2v.models.networks.flux2_dev.weights.pre_weights import Flux2DevPreWeights
...
class Flux2DevTransformerModel(BaseTransformerModel):
    ...
    def _infer_cond_uncond(self, latents_input, prompt_embeds, infer_condition=True, txt_ids=None, img_ids=None):
        """Single forward pass with embedded guidance (no CFG needed for Flux2 dev)."""
    ...
    def infer(self, inputs):
        ...
        # Flux2 dev: single forward pass with embedded guidance
